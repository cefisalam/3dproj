...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        widget2->setStyleSheet(QStringLiteral("background-color: rgb(170, 255, 0);"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        groupBox->setTitle(QApplication::translate("MainWindow", "Features", Q_NULLPTR));
        groupBox_2->setTitle(QApplication::translate("MainWindow", "Viewer", Q_NULLPTR));
